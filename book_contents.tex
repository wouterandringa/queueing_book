...
The queueing systems we analyzed up to now the server is always present to serve jobs in the system, but this condition is not always satisfied.
As an example, consider a system in which there is a cost associated with switching on and off the server.
...
\input{tex_files/n_policies.tex}
