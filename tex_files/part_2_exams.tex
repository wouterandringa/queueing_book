...
\begin{exercise}[201803]
If a job arrives at time $A$, and $\{L(t)\}$ is the queue length process, then the random variable $L(A)$ denotes the number in the system seen by this job upon arrival.
\begin{solution}
