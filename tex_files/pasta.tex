...
\end{equation}
Note that the derivation of this fact does not depend on the distribution of the inter-arrival or service times.
Hence, it is true for the rate-stable $G/G/1$ queue.
