...
\begin{exercise}[Continuation of~\cref{ex:111}] \label{ex:112} 
...
\begin{exercise}[Continuation of~\cref{ex:112}] \label{ex:113} Compute $p(n)$ and $\lambda(n)$.
\begin{solution}
...
\begin{exercise}[Continuation of~\cref{ex:113}] \label{ex:4}
Compute 
...
\begin{exercise}[Continuation of~\cref{ex:4}] Compute $\lambda(n) p(n)$ for $n\geq 0$, and check $\lambda(n) p(n) = \mu(n+1) p(n+1)$.
\begin{solution}
