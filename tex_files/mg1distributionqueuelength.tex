...
\begin{exercise}\label{ex:30} Design a suitable numerical method to evaluate~\cref{eq:10} for more general distribution functions $F$.
\begin{hint}
...
\begin{exercise}
Use a similar derivation as in~\cref{eq:1332} to   show that 
\begin{equation*}
