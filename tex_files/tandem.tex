...
Suppose we can remove all variability of the service process at the second station. Show that in this case the total time in queue is equal to
\begin{equation*}
...
What is $C_d^2$ for the $M/M/1$ queue according to~\cref{eq:40}? 
