...
For ease we assume that the job's \recall{net service time}, $S_0$, has the same distribution for both colors.
...
We first provide a list of elements required to compute the expected sojourn time of an item.
