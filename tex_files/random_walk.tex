...
In this section, we show how to build the queueing process $\{L_k\}$ from a random walk $\{Z_k\}$ using a device called a \emph{reflection map}, which gives an elegant construction of a queueing process.
