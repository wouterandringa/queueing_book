...
\begin{solution}
 ...
 By~\cref{eq:6} $\E{N(t)} = \lambda t$.  We want the expectations of $N_n(t)$ and $N(t)$ to be the same,  that is, $n p = \lambda t$. 
\end{solution}
\end{extra}
...
\V{N(t)} = \lambda t.
  \end{equation*}
  \begin{hint} Use~\cref{eq:68}. Compute $\E{N^2}$ and use Exercise~\ref{ex:2}.
  \end{hint}
  \begin{solution} 
...
\begin{extra}
Use the solution of Exercise~\ref{ex:1} to prove the result of Exercise~\ref{ex:31}. 
\begin{solution}
