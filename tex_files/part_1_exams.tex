...
%4
\begin{exercise}[201703] Assume that
...
%7
\begin{exercise}[201703] A machine can switch on and off. If the queue length
...
\begin{exercise}[201704] For the situation of the previous question, find a recursion to compute a tight upper bound on the time the arriving work $a_k^i$ spends in the system.
\begin{solution}
